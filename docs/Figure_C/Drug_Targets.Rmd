...
material_gradient <- colorRampPalette(
	c("#b71c1c", "#c62828", "#d32f2f", "#e53935", "#f44336", #reds
		"white",
		"#2196f3", "#1e88e5", "#1976d2", "#1565c0", "#0d47a1"), #blues
	interpolate = "linear")
...
to_plot_title <- "Median LogFC in Perfect NADH Guides"
...
plot_colors <- material_gradient(256)
