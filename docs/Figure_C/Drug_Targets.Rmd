...
CL2682 <- fread("../../CL2687.tsv") 

# Ribosome, why is rplY and rpmB not being painted in plots?
map03010 <- fread("../../map03010.tsv") 

# Lipopolysaccharide in AB030 KEGG, map 00540
LPS <- fread("../../LPS.tsv") 

# Quinone, and NADH:quinone oxidoreductase/Mrp antiporter, membrane subunit
CL3048 <- fread("../../CL3048.tsv") 
...
aba.genome[AB030 %in% CL2682$AB030, Pathway := "Cell Wall/PG"]
aba.genome[AB030 %in% map03010$AB030, Pathway := "Ribosome"]
aba.genome[AB030 %in% LPS$AB030, Pathway := "LPS"]
aba.genome[unique_name %like% "lpt", Pathway := "LPS"]
aba.genome[unique_name == "gtrOC1", Pathway := "LPS"]
aba.genome[AB030 %in% CL3048$AB030, Pathway := "Quinone/NADH"]
...
median_LFC <- dcast(
	melted_results[Pathway == "Quinone/NADH" & type == "perfect"], 
...
to_plot_title <- "Median LogFC in Perfect Quinone/NADH Guides"
...
plot_colors <- colorRampPalette(
	c("#ba000d", "white", "#007ac1"),
	interpolate = "linear")(256)
...
to_plot_title <- "Median LogFC in Perfect LPS Guides"
...
```{r Cell Wall activity in Imipenem, fig.width=10, fig.height=8}
median_LFC <- dcast(
...
to_plot_title <- "Median LogFC in Perfect Cell Wall/PG Guides"
...
```{r Cell Wall activity in Meropenem, fig.width=10, fig.height=8}
median_LFC <- dcast(
	melted_results[Pathway == "Cell Wall/PG" & type == "perfect"], 
	unique_name + Pathway ~ condition, 
	value.var = "LFC.adj", 
