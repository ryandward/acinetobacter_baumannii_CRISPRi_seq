...
## this heatmap has cipro and levo next to each other
geneSetHeatMap <- repreSetsAndScoresMatrix %>%
  cor() %>%
  pheatmap(clustering_method = "ward.D2", clustering_distance_rows = "correlation", clustering_distance_cols = "correlation")

print(geneSetHeatMap)
